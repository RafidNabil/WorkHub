...
namespace WorkHub.Controllers
{
    public class DeveloperController : Controller
    {
        ...
        public ActionResult RecentCom()
        {
            return View();
        }

        public ActionResult ActiveBran()
        {
            return View();
        }

        public ActionResult RepositoryView()
        {
            return View();
        }
        ...
        public ActionResult BuildStatus()
        {
            return View();
        }
        ...
        public ActionResult DeploymentStatus()
        {
            return View();
        }
